...
type Lead struct {
	...
	Tasks    []LeadTask          `json:"tasks,omitempty" gorm:"foreignKey:leadId" validate:""`
	TimeLine []LeadTimelineEvent `json:"timeLine,omitempty" gorm:"foreignKey:leadId" validate:""`
...
type LeadTimelineEvent struct {
	...
	Time                string   `json:"time" gorm:"column:time;not null" validate:"required"`
	Notes               string   `json:"notes,omitempty" gorm:"column:note" validate:""`
	AttendedBy          User     `json:"attendedBy" gorm:"foreignKey:id" validate:""`
...
type Campaign struct {
	...
	Referrals   []Referral `json:"referrals" gorm:"foreignKey:campaignId" validate:""`
}

type Referral struct {
	db.BaseModel
	CampaignID  uint    `json:"campaignId" gorm:"column:campaignId" validate:"required"`
	Referrer    User    `json:"referrer" gorm:"foreignKey:id" validate:""`
	Description string  `json:"description" gorm:"column:description" validate:""`
